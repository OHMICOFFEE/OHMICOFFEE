...
export default function AdminLogin() {
  ...
  async function login(e: React.FormEvent) {
    ...
    setLoading(true)
    setError('')
    if (password === 'ohmi2025' || password === process.env.NEXT_PUBLIC_ADMIN_PASSWORD) {
    ...
    <div className="login-wrap">
      <div className="login-box">
        ...
        <form onSubmit={login}>
          ...
          <button type="submit" className="btn btn-red" style={{width:'100%',marginTop:4}} disabled={loading}>
